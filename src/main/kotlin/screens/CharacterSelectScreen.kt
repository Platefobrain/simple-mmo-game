...
data class CharacterInfo(
    ...
    val maxHealth: Int = 100,         // Add default value
    val currentHealth: Int = 100      // Add default value
)
    ...
    private fun loadCharacters() {
        selectionScope.launch {
            try {
                ...
                val response = httpClient.post("http://localhost:8080/character/list") {
    ...
    private fun selectCharacter(slotIndex: Int, character: CharacterInfo) {
        selectionScope.launch {
            try {
                ...
                val response = httpClient.post("http://localhost:8080/character/select") {
                    contentType(ContentType.Application.Json)
